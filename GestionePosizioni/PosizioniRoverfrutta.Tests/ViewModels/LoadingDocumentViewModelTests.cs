...
namespace PosizioniRoverfrutta.Tests.ViewModels
{
    ...
    public class LoadingDocumentViewModelTests
    {
        ...
        public void Setup()
        {
            _mainViewModel = new LoadingDocumentViewModel(_dataStorage, _mockWindowManager.Object);
        }
        ...
        [Test]
        public void when_converting_a_sale_confirmation_into_loading_document_the_save_button_is_enabled_and_action_buttons_are_disabled_and_reload_button_is_disabled ()
        {
        ...
        private void CreateSaleConfirmation()
        {
