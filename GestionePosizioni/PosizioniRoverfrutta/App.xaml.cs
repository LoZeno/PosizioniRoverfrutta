...
namespace PosizioniRoverfrutta
{
    ...
    public partial class App : Application
    {
        ...
        private void InitializeWindowManager()
        {
            ...
            _windowManager.RegisterWindowClass(WindowTypes.Riepiloghi, typeof(InvoicesList));
            ...
            _windowManager.RegisterWindowClass(WindowTypes.StatisticheProdotti, typeof(ProductsStatistics));
        }
